...
# from main import ContactManager, Contact
...
#     old_name = st.text_input("Enter the name of the contact to edit")
#     new_name = st.text_input("New Name")
#     selected_country = st.selectbox("Select Country Code", list(COUNTRIES.keys()))
#     raw_phone = st.text_input("New Phone Number (10 digits)")
...
#             manager.edit_contact(old_name, new_contact)
...
import streamlit as st                          # For building the Streamlit web app interface
from main import ContactManager, Contact        # Importing core logic and data structure from main.py

# Dictionary of predefined countries and their dialing codes
COUNTRIES = {
...
# Create a ContactManager instance to handle operations (CRUD)
manager = ContactManager()
...
if choice == "Add Contact":
    ...
    name = st.text_input("Full Name")
    selected_country = st.selectbox("Select Country", list(COUNTRIES.keys()))  # Country selector
    raw_phone = st.text_input("Phone Number (10 digits only)")
    email = st.text_input("Email")
