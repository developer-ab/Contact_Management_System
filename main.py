...
# CONTACT_FILE = 'contacts.txt' # creating a variable to represent the contact text file.

# # Contact Template using Class
# class Contact:
...
#                 # If phone number changed, check for duplicates
